    ...
    public class AdminsClass
    {
        ...
        public static int AddRecord(Admins admin)
        {
            ...
            try
            {
                ...
                if (!expired)
                {
                    var exist = db.Admins.FirstOrDefault(x => x.UserName.Equals(admin.UserName));
                    if (exist == null)
                    {
                        TimeZoneInfo est;
                        try
        ...
        public static int UpdateRecord(Admins UA)
        {
            ...
            try
            {
                ...
                if (!expired)
                {
                    var exist = db.Admins.FirstOrDefault(x => x.UserName.Equals(UA.UserName) && x.ID != UA.ID);
                    if (exist == null)
                    {
